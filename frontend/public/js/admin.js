...
function addMarks(studentId, subjectCode, marks) {
    // Send request to backend API to add marks
    fetch('/api/admin/addMarks', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
...
function addAttendance(studentId, date, status) {
    // Send request to backend API to add attendance
    fetch('/api/admin/addAttendance', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
