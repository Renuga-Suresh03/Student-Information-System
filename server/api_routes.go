...
func SetupAPIRoutes(router *gin.Engine, adminController *controllers.AdminController, markController *controllers.MarkController, attendanceController *controllers.AttendanceController) {
